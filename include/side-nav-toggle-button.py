...
if params["toggle"] == "yes":
    txt += f'    <a class="side-nav-button-text side-nav-button-text-toggle" style="padding-left: {params["indent"]}rem">\n'
    txt += f'        {params["text"]}\n'
    txt += f'    </a>\n'
    ...
    txt += f'    <a class="side-nav-button-text" style="padding-left: {params["indent"]}rem">\n'
    txt += f'        {params["text"]}\n'
    txt += f'    </a>\n'
